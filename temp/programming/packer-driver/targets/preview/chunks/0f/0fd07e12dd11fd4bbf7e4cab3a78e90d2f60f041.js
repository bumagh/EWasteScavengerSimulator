  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameUICtrl", GameUICtrl = (_dec = ccclass('GameUICtrl'), _dec2 = property(Prefab), _dec(_class = (_class2 = class GameUICtrl extends (_crd && NodeRef === void 0 ? (_reportPossibleCrUseOfNodeRef({
        ...
        BallBeat() {
          var centerPos = new Vec3(this.heroBall.ballSpriteNode.position.x, this.heroBall.ballSpriteNode.position.y);
          var direction = centerPos.subtract(this.centerPointLocalToBallPos).normalize();
